(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-main-table-main-table-module"],{
...
/* harmony import */ var _services_providers_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./services/providers.service */ "./src/app/core/services/providers.service.ts");
/* harmony import */ var _services_stores_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./services/stores.service */ "./src/app/core/services/stores.service.ts");
/* harmony import */ var _services_stocks_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./services/stocks.service */ "./src/app/core/services/stocks.service.ts");
...
var CoreModule = /** @class */ (function () {
    ...
    CoreModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_services_products_service__WEBPACK_IMPORTED_MODULE_3__["ProductsService"], _services_providers_service__WEBPACK_IMPORTED_MODULE_4__["ProvidersService"], _services_stores_service__WEBPACK_IMPORTED_MODULE_5__["StoresService"], _services_stocks_service__WEBPACK_IMPORTED_MODULE_6__["StocksService"]]
        })
    ], CoreModule);
    return CoreModule;
}());
...
var ProductsService = /** @class */ (function () {
     ...
     */
    ProductsService.prototype.updateProduct = function (payload) {
        var list = this.getProducts();
        var oldElement = list.find(function (element) { return element.id === payload.id; });
     ...
     */
    ProductsService.prototype.addQuantity = function (id, quantity) {
        var list = this.getProducts();
        var product = list.find(function (element) { return element.id === id; });
     ...
     */
    ProductsService.prototype.disccountQuantity = function (id, quantity) {
        var list = this.getProducts();
        var product = list.find(function (element) { return element.id === id; });
        product.quantity -= quantity;
        // list.splice(list.indexOf(pr), 1, payload);
    ...
    ProductsService.prototype.deleteProduct = function (id) {
        var list = this.getProducts();
        var element = list.find(function (element) { return element.id === id; });
        list.splice(list.indexOf(element), 1);
        localStorage.setItem(PRODUCTS, JSON.stringify(list));
    };
    Object.defineProperty(ProductsService.prototype, "isStorageEmpty", {
        /**
         * @name isStorageEmpty
    ...
    Object.defineProperty(ProductsService.prototype, "productsList", {
        /**
         * @name productsList
...
/***/ "./src/app/core/services/providers.service.ts":
/*!****************************************************!*\
  !*** ./src/app/core/services/providers.service.ts ***!
  \****************************************************/
...
var PROVIDERS = 'DT_TEST_PROVIDERS';
var ProvidersService = /** @class */ (function () {
     ...
     * @param payload object to create or edit on the list.
     */
    ProvidersService.prototype.updateProvider = function (payload) {
        var list = this.getProviders();
        var oldElement = list.find(function (element) { return element.id === payload.id; });
        oldElement ? list.splice(list.indexOf(oldElement), 1, payload) : list.push(payload);
     ...
     * @param id id of the element to remove.
     */
    ProvidersService.prototype.deleteProvider = function (id) {
        var list = this.getProviders();
        var element = list.find(function (element) { return element.id === id; });
        list.splice(list.indexOf(element), 1);
        localStorage.setItem(PROVIDERS, JSON.stringify(list));
    };
    Object.defineProperty(ProvidersService.prototype, "isStorageEmpty", {
        /**
         * @name isStorageEmpty
         * @description returns true if there is at least one element on the storage.
         */
    ...
    Object.defineProperty(ProvidersService.prototype, "providersList", {
        /**
         * @name providersList
         * @description returns the string form of the element's array.
         */
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _products_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./products.service */ "./src/app/core/services/products.service.ts");



var STOCKS = 'DT_TEST_STOCKS';
var StocksService = /** @class */ (function () {
    function StocksService(_productsService) {
     ...
     * @param payload object to create or edit on the list.
     */
    StocksService.prototype.updateStock = function (payload) {
        var list = this.getStocks();
        var oldElement = list.find(function (element) { return element.id === payload.id; });
        oldElement ? list.splice(list.indexOf(oldElement), 1, payload) : list.push(payload);
     ...
     * @param id id of the element to remove.
     */
    StocksService.prototype.deleteStock = function (id) {
        var list = this.getStocks();
        var element = list.find(function (element) { return element.id === id; });
    ...
    Object.defineProperty(StocksService.prototype, "isStorageEmpty", {
        /**
         * @name isStorageEmpty
         * @description returns true if there is at least one element on the storage.
         */
    ...
    Object.defineProperty(StocksService.prototype, "stocksList", {
        /**
         * @name stocksList
         * @description returns the string form of the element's array.
         */
...
/***/ "./src/app/core/services/stores.service.ts":
/*!*************************************************!*\
  !*** ./src/app/core/services/stores.service.ts ***!
  \*************************************************/
...
var StoresService = /** @class */ (function () {
     ...
     * @param payload object to create or edit on the list.
     */
    StoresService.prototype.updateStore = function (payload) {
        var list = this.getStores();
        var oldElement = list.find(function (element) { return element.id === payload.id; });
        oldElement ? list.splice(list.indexOf(oldElement), 1, payload) : list.push(payload);
     ...
     * @param id id of the element to remove.
     */
    StoresService.prototype.deleteStore = function (id) {
        var list = this.getStores();
        var element = list.find(function (element) { return element.id === id; });
        list.splice(list.indexOf(element), 1);
        localStorage.setItem(STORES, JSON.stringify(list));
    };
    Object.defineProperty(StoresService.prototype, "isStorageEmpty", {
        /**
         * @name isStorageEmpty
         * @description returns true if there is at least one element on the storage.
         */
    ...
    Object.defineProperty(StoresService.prototype, "storesList", {
        /**
         * @name storesList
         * @description returns the string form of the element's array.
         */
...
/***/ "./src/app/core/utils/select.utils.ts":
/*!********************************************!*\
  !*** ./src/app/core/utils/select.utils.ts ***!
  \********************************************/
...
/***/ "./src/app/modules/main-table/components/products/products.component.html":
/*!********************************************************************************!*\
  !*** ./src/app/modules/main-table/components/products/products.component.html ***!
  \********************************************************************************/
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL21vZHVsZXMvbWFpbi10YWJsZS9jb21wb25lbnRzL3Byb2R1Y3RzL3Byb2R1Y3RzLmNvbXBvbmVudC5zY3NzIn0= */"

/***/ }),

/***/ "./src/app/modules/main-table/components/products/products.component.ts":
/*!******************************************************************************!*\
  !*** ./src/app/modules/main-table/components/products/products.component.ts ***!
  \******************************************************************************/
...
/* harmony import */ var src_app_core_services_products_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/core/services/products.service */ "./src/app/core/services/products.service.ts");
/* harmony import */ var src_app_core_services_providers_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/core/services/providers.service */ "./src/app/core/services/providers.service.ts");
/* harmony import */ var src_app_core_services_stocks_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/core/services/stocks.service */ "./src/app/core/services/stocks.service.ts");
...
var ProductsComponent = /** @class */ (function () {
    function ProductsComponent(_fb, _msg, _service, _providersService, _stocksService) {
        this._fb = _fb;
        this._msg = _msg;
     ...
     */
    ProductsComponent.prototype.fillList = function () {
        var _this = this;
        var list = this._service.getProducts();
        list.forEach(function (element) {
            _this.addElement(element);
        });
    };
    Object.defineProperty(ProductsComponent.prototype, "providers", {
        /**
         * @name providers
     ...
     */
    ProductsComponent.prototype.providerName = function (id) {
        return this.providers.find(function (element) { return element.id === id; }).name;
    };
    /**
     * @name generateForm
     * @description returns the empty and initialized form group.
     */
    ProductsComponent.prototype.generateForm = function () {
     ...
     */
    ProductsComponent.prototype.confirm = function (element) {
        if (element.valid) {
            var payload = element.value;
            delete payload.edit;
            this._service.updateProduct(payload);
     ...
     */
    ProductsComponent.prototype.addElement = function (element) {
        var list = this.list.get('list');
        list.insert(0, this._fb.group({
            id: [element ? element.id : String(new Date().getTime())],
            name: [element ? element.name : null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            providerId: [element ? element.providerId : null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            quantity: [element ? element.quantity : null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
     ...
     */
    ProductsComponent.prototype.deleteElement = function (index) {
        var list = this.list.get('list');
        var id = list.get(String(index)).value.id;
     ...
     */
    ProductsComponent.prototype.canDeleteProduct = function (id) {
        return !this._stocksService.getStocks().find(function (element) { return element.productId === id; });
    };
    ProductsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-products',
            template: __webpack_require__(/*! ./products.component.html */ "./src/app/modules/main-table/components/products/products.component.html"),
            styles: [__webpack_require__(/*! ./products.component.scss */ "./src/app/modules/main-table/components/products/products.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"],
            angular_notifier__WEBPACK_IMPORTED_MODULE_3__["NotifierService"],
            src_app_core_services_products_service__WEBPACK_IMPORTED_MODULE_4__["ProductsService"],
            src_app_core_services_providers_service__WEBPACK_IMPORTED_MODULE_5__["ProvidersService"],
            src_app_core_services_stocks_service__WEBPACK_IMPORTED_MODULE_6__["StocksService"]])
    ], ProductsComponent);
...
/***/ "./src/app/modules/main-table/components/providers/providers.component.html":
/*!**********************************************************************************!*\
  !*** ./src/app/modules/main-table/components/providers/providers.component.html ***!
  \**********************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/modules/main-table/components/providers/providers.component.scss":
/*!**********************************************************************************!*\
  !*** ./src/app/modules/main-table/components/providers/providers.component.scss ***!
  \**********************************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL21vZHVsZXMvbWFpbi10YWJsZS9jb21wb25lbnRzL3Byb3ZpZGVycy9wcm92aWRlcnMuY29tcG9uZW50LnNjc3MifQ== */"

/***/ }),

/***/ "./src/app/modules/main-table/components/providers/providers.component.ts":
/*!********************************************************************************!*\
  !*** ./src/app/modules/main-table/components/providers/providers.component.ts ***!
  \********************************************************************************/
...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var angular_notifier__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! angular-notifier */ "./node_modules/angular-notifier/esm5/angular-notifier.js");
/* harmony import */ var src_app_core_services_providers_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/core/services/providers.service */ "./src/app/core/services/providers.service.ts");
/* harmony import */ var src_app_core_services_products_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/core/services/products.service */ "./src/app/core/services/products.service.ts");
...
var ProvidersComponent = /** @class */ (function () {
    function ProvidersComponent(_fb, _msg, _service, _productsService) {
        this._fb = _fb;
        this._msg = _msg;
        this._service = _service;
        this._productsService = _productsService;
     ...
     * @description fills the list with the storage elements if they exist.
     */
    ProvidersComponent.prototype.fillList = function () {
        var _this = this;
        var list = this._service.getProviders();
        list.forEach(function (element) {
            _this.addElement(element);
        });
    };
     ...
     * @description returns the empty and initialized form group.
     */
    ProvidersComponent.prototype.generateForm = function () {
        return this._fb.group({
            list: this._fb.array([])
        });
    };
     ...
     * @param element formgroup object that represents the element to create.
     */
    ProvidersComponent.prototype.confirm = function (element) {
        if (element.valid) {
            var payload = element.value;
            delete payload.edit;
            this._service.updateProvider(payload);
            element.get('edit').setValue(false);
            this._msg.notify('success', 'Excelente!, el elemento fue guardado correctamente.', String(new Date().getTime()));
        }
        else {
     ...
     * @param element (optional) if exists, sets an element with preloaded information.
     */
    ProvidersComponent.prototype.addElement = function (element) {
        var list = this.list.get('list');
        list.insert(0, this._fb.group({
            id: [element ? element.id : String(new Date().getTime())],
            name: [element ? element.name : null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
     ...
     * @param index index of the element to remove from the list.
     */
    ProvidersComponent.prototype.deleteElement = function (index) {
        var list = this.list.get('list');
        var id = list.get(String(index)).value.id;
     ...
     * @id id of the provider to test.
     */
    ProvidersComponent.prototype.canDeleteProvider = function (id) {
        return !this._productsService.getProducts().find(function (element) { return element.providerId === id; });
    };
    ProvidersComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-providers',
            template: __webpack_require__(/*! ./providers.component.html */ "./src/app/modules/main-table/components/providers/providers.component.html"),
            styles: [__webpack_require__(/*! ./providers.component.scss */ "./src/app/modules/main-table/components/providers/providers.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], angular_notifier__WEBPACK_IMPORTED_MODULE_3__["NotifierService"], src_app_core_services_providers_service__WEBPACK_IMPORTED_MODULE_4__["ProvidersService"], src_app_core_services_products_service__WEBPACK_IMPORTED_MODULE_5__["ProductsService"]])
    ], ProvidersComponent);
...
/***/ "./src/app/modules/main-table/components/stocks/stocks.component.html":
/*!****************************************************************************!*\
  !*** ./src/app/modules/main-table/components/stocks/stocks.component.html ***!
  \****************************************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"row col-12 mx-0 mb-3 justify-content-end\">\r\n    <button class=\"btn-create py-2 px-3\" (click)=\"addElement()\"><i class=\"fas fa-plus mr-2\"></i>Agregar</button>\r\n</div>\r\n\r\n<form [formGroup]=\"list\">\r\n    <table class=\"table table-hover \">\r\n        <thead class=\"thead-dark\">\r\n            <tr>\r\n                <th scope=\"col\">Id</th>\r\n                <th scope=\"col\">Tienda</th>\r\n                <th scope=\"col\">Producto</th>\r\n                <th scope=\"col\">Cantidad</th>\r\n                <th scope=\"col\">Fecha de Compra</th>\r\n                <th style=\"text-align:center;\" scope=\"col\">Acciones</th>\r\n            </tr>\r\n        </thead>\r\n        <ng-template [ngIf]=\"list.value.list.length> 0\">\r\n            <tbody formArrayName=\"list\" *ngFor=\"let item of list.get('list').controls | paginate: { itemsPerPage: 5, currentPage: page }; let i = index\">\r\n                <tr [formGroupName]='i'>\r\n                    <th scope=\"row\">{{item.value.id}}</th>\r\n                    <td>\r\n                        <ng-template [ngIf]=\"item.value.edit\">\r\n                            <select class=\"form-control\" name=\"storeId\" id=\"storeId\" formControlName=\"storeId\">\r\n                                <option *ngFor=\"let element of stores\" [value]=\"element.id\">{{element.name}}</option>\r\n                            </select>\r\n                        </ng-template>\r\n                        <ng-template [ngIf]=\"!item.value.edit\">\r\n                            {{storeName(item.value.storeId)}}\r\n                        </ng-template>\r\n                    </td>\r\n                    <td>\r\n                        <ng-template [ngIf]=\"item.value.edit\">\r\n                            <select class=\"form-control\" name=\"productId\" id=\"productId\" formControlName=\"productId\">\r\n                                <option *ngFor=\"let element of products\" [value]=\"element.id\">{{element.name}}</option>\r\n                            </select>\r\n                        </ng-template>\r\n                        <ng-template [ngIf]=\"!item.value.edit\">\r\n                            {{productName(item.value.productId)}}\r\n                        </ng-template>\r\n                    </td>\r\n                    <td>\r\n                        <ng-template [ngIf]=\"item.value.edit\">\r\n                            <input class=\"form-control\" type=\"number\" name=\"productsQuantity\" id=\"productsQuantity\" formControlName=\"productsQuantity\">\r\n                        </ng-template>\r\n                        <ng-template [ngIf]=\"!item.value.edit\">\r\n                            {{item.value.productsQuantity}}\r\n                        </ng-template>\r\n                    </td>\r\n                    <td>\r\n                        <ng-template [ngIf]=\"item.value.edit\">\r\n                            <input class=\"form-control\" type=\"date\" name=\"purchaseDate\" id=\"purchaseDate\" formControlName=\"purchaseDate\">\r\n                        </ng-template>\r\n                        <ng-template [ngIf]=\"!item.value.edit\">\r\n                            {{item.value.purchaseDate | date: 'dd/MM/yyyy hh:mm'}}\r\n                        </ng-template>\r\n                    </td>\r\n                    <td class=\"actions\">\r\n                        <ng-template [ngIf]=\"!item.value.edit\">\r\n                            <i tooltip=\"Editar\" placement=\"top\" show-delay=\"100\" class=\"action-btn color-info fas fa-pencil-alt mr-3\" (click)=\"item.get('edit').setValue(true)\"></i>\r\n                            <i tooltip=\"Eliminar\" placement=\"top\" show-delay=\"100\" class=\"action-btn color-danger fas fa-trash-alt\" (click)=\"deleteElement(i)\"></i>\r\n                        </ng-template>\r\n                        <ng-template [ngIf]=\"item.value.edit\">\r\n                            <button class=\"btn-confirm py-1 px-2\" (click)=\"confirm(item)\"><i class=\"fas fa-check mr-2\"></i>Confirmar</button>\r\n                        </ng-template>\r\n                    </td>\r\n                </tr>\r\n            </tbody>\r\n        </ng-template>\r\n    </table>\r\n</form>\r\n<ng-template [ngIf]=\"list.value.list.length === 0\">\r\n    <p class=\"empty-list\">Actualmente no contiene registros, puede agregar uno con el botón azul de arriba.</p>\r\n</ng-template>\r\n<ng-template [ngIf]=\"list.value.list.length > 0\">\r\n    <pagination-controls (pageChange)=\"page = $event\"></pagination-controls>\r\n</ng-template>"

/***/ }),

/***/ "./src/app/modules/main-table/components/stocks/stocks.component.scss":
/*!****************************************************************************!*\
  !*** ./src/app/modules/main-table/components/stocks/stocks.component.scss ***!
  \****************************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL21vZHVsZXMvbWFpbi10YWJsZS9jb21wb25lbnRzL3N0b2Nrcy9zdG9ja3MuY29tcG9uZW50LnNjc3MifQ== */"

/***/ }),

/***/ "./src/app/modules/main-table/components/stocks/stocks.component.ts":
/*!**************************************************************************!*\
  !*** ./src/app/modules/main-table/components/stocks/stocks.component.ts ***!
  \**************************************************************************/
...
/* harmony import */ var angular_notifier__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! angular-notifier */ "./node_modules/angular-notifier/esm5/angular-notifier.js");
/* harmony import */ var src_app_core_services_products_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/core/services/products.service */ "./src/app/core/services/products.service.ts");
/* harmony import */ var src_app_core_services_stocks_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/core/services/stocks.service */ "./src/app/core/services/stocks.service.ts");
/* harmony import */ var src_app_core_services_stores_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/core/services/stores.service */ "./src/app/core/services/stores.service.ts");
...
var StocksComponent = /** @class */ (function () {
    function StocksComponent(_fb, _msg, _service, _storesService, _productsService) {
        this._fb = _fb;
        this._msg = _msg;
        this._service = _service;
     ...
     * @description fills the list with the storage elements if they exist.
     */
    StocksComponent.prototype.fillList = function () {
        var _this = this;
        var list = this._service.getStocks();
        list.forEach(function (element) {
            _this.addElement(element);
        });
    };
    Object.defineProperty(StocksComponent.prototype, "products", {
        /**
         * @name products
    ...
    Object.defineProperty(StocksComponent.prototype, "stores", {
        /**
         * @name stores
     ...
     */
    StocksComponent.prototype.storeName = function (id) {
        return this.stores.find(function (element) { return element.id === id; }).name;
    };
    /**
     * @name productName
     ...
     */
    StocksComponent.prototype.productName = function (id) {
        return this.products.find(function (element) { return element.id === id; }).name;
    };
    /**
     ...
     * @param id id of the product to search.
     */
    StocksComponent.prototype.productQuantity = function (id) {
        return this.products.find(function (element) { return element.id === id; }).quantity;
    };
    /**
     * @name generateForm
     * @description returns the empty and initialized form group.
     */
    StocksComponent.prototype.generateForm = function () {
        return this._fb.group({
            list: this._fb.array([])
        });
    };
     ...
     * @param element formgroup object that represents the element to create.
     */
    StocksComponent.prototype.confirm = function (element) {
        if (element.valid) {
            ...
            if (this.validQuantity(element.value.productId, element.value.productsQuantity)) {
                ...
                this._service.updateStock(payload);
                element.get('edit').setValue(false);
                this._msg.notify('success', 'Excelente!, el elemento fue guardado correctamente.', String(new Date().getTime()));
            }
            else {
     ...
     */
    StocksComponent.prototype.validQuantity = function (id, quantity) {
     ...
     * @param element (optional) if exists, sets an element with preloaded information.
     */
    StocksComponent.prototype.addElement = function (element) {
        var list = this.list.get('list');
        list.insert(0, this._fb.group({
            id: [element ? element.id : String(new Date().getTime())],
            storeId: [element ? element.storeId : null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            productId: [element ? element.productId : null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            productsQuantity: [element ? element.productsQuantity : null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            oldProductsQuantity: [element ? element.productsQuantity : 0],
            purchaseDate: [element ? element.purchaseDate : new Date(), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            edit: [element ? false : true]
        }));
        if (!element) {
            this.page = 1;
     ...
     * @param index index of the element to remove from the list.
     */
    StocksComponent.prototype.deleteElement = function (index) {
        var list = this.list.get('list');
        var id = list.get(String(index)).value.id;
    ...
    StocksComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-stocks',
            template: __webpack_require__(/*! ./stocks.component.html */ "./src/app/modules/main-table/components/stocks/stocks.component.html"),
            styles: [__webpack_require__(/*! ./stocks.component.scss */ "./src/app/modules/main-table/components/stocks/stocks.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"],
            angular_notifier__WEBPACK_IMPORTED_MODULE_3__["NotifierService"],
            src_app_core_services_stocks_service__WEBPACK_IMPORTED_MODULE_5__["StocksService"],
            src_app_core_services_stores_service__WEBPACK_IMPORTED_MODULE_6__["StoresService"],
            src_app_core_services_products_service__WEBPACK_IMPORTED_MODULE_4__["ProductsService"]])
    ], StocksComponent);
...
/***/ "./src/app/modules/main-table/components/stores/stores.component.html":
/*!****************************************************************************!*\
  !*** ./src/app/modules/main-table/components/stores/stores.component.html ***!
  \****************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/modules/main-table/components/stores/stores.component.scss":
/*!****************************************************************************!*\
  !*** ./src/app/modules/main-table/components/stores/stores.component.scss ***!
  \****************************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL21vZHVsZXMvbWFpbi10YWJsZS9jb21wb25lbnRzL3N0b3Jlcy9zdG9yZXMuY29tcG9uZW50LnNjc3MifQ== */"

/***/ }),

/***/ "./src/app/modules/main-table/components/stores/stores.component.ts":
/*!**************************************************************************!*\
  !*** ./src/app/modules/main-table/components/stores/stores.component.ts ***!
  \**************************************************************************/
...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var angular_notifier__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! angular-notifier */ "./node_modules/angular-notifier/esm5/angular-notifier.js");
/* harmony import */ var src_app_core_services_stores_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/core/services/stores.service */ "./src/app/core/services/stores.service.ts");
/* harmony import */ var src_app_core_services_stocks_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/core/services/stocks.service */ "./src/app/core/services/stocks.service.ts");
...
var StoresComponent = /** @class */ (function () {
    function StoresComponent(_fb, _msg, _service, _stocksService) {
        this._fb = _fb;
        this._msg = _msg;
        this._service = _service;
        this._stocksService = _stocksService;
     ...
     * @description fills the list with the storage elements if they exist.
     */
    StoresComponent.prototype.fillList = function () {
        var _this = this;
        var list = this._service.getStores();
        list.forEach(function (element) {
            _this.addElement(element);
        });
    };
     ...
     * @description returns the empty and initialized form group.
     */
    StoresComponent.prototype.generateForm = function () {
        return this._fb.group({
            list: this._fb.array([])
        });
    };
     ...
     * @param element formgroup object that represents the element to create.
     */
    StoresComponent.prototype.confirm = function (element) {
        if (element.valid) {
            var payload = element.value;
            delete payload.edit;
            this._service.updateStore(payload);
            element.get('edit').setValue(false);
            this._msg.notify('success', 'Excelente!, el elemento fue guardado correctamente.', String(new Date().getTime()));
        }
        else {
     ...
     * @param element (optional) if exists, sets an element with preloaded information.
     */
    StoresComponent.prototype.addElement = function (element) {
        var list = this.list.get('list');
        list.insert(0, this._fb.group({
            id: [element ? element.id : String(new Date().getTime())],
            name: [element ? element.name : null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
     ...
     * @param index index of the element to remove from the list.
     */
    StoresComponent.prototype.deleteElement = function (index) {
        var list = this.list.get('list');
        var id = list.get(String(index)).value.id;
     ...
     */
    StoresComponent.prototype.canDeleteStore = function (id) {
        return !this._stocksService.getStocks().find(function (element) { return element.storeId === id; });
    };
    StoresComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-stores',
            template: __webpack_require__(/*! ./stores.component.html */ "./src/app/modules/main-table/components/stores/stores.component.html"),
            styles: [__webpack_require__(/*! ./stores.component.scss */ "./src/app/modules/main-table/components/stores/stores.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], angular_notifier__WEBPACK_IMPORTED_MODULE_3__["NotifierService"], src_app_core_services_stores_service__WEBPACK_IMPORTED_MODULE_4__["StoresService"], src_app_core_services_stocks_service__WEBPACK_IMPORTED_MODULE_5__["StocksService"]])
    ], StoresComponent);
...
/***/ "./src/app/modules/main-table/main-table-routing.module.ts":
/*!*****************************************************************!*\
  !*** ./src/app/modules/main-table/main-table-routing.module.ts ***!
  \*****************************************************************/
/*! exports provided: MainTableRoutingModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MainTableRoutingModule", function() { return MainTableRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _pages_table_table_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./pages/table/table.component */ "./src/app/modules/main-table/pages/table/table.component.ts");
...
var MainTableRoutingModule = /** @class */ (function () {
    function MainTableRoutingModule() {
    }
    MainTableRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes)],
            exports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]]
        })
    ], MainTableRoutingModule);
    return MainTableRoutingModule;
}());
...
/* harmony import */ var _main_table_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./main-table-routing.module */ "./src/app/modules/main-table/main-table-routing.module.ts");
/* harmony import */ var _pages_table_table_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./pages/table/table.component */ "./src/app/modules/main-table/pages/table/table.component.ts");
/* harmony import */ var _components_products_products_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/products/products.component */ "./src/app/modules/main-table/components/products/products.component.ts");
/* harmony import */ var _components_providers_providers_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/providers/providers.component */ "./src/app/modules/main-table/components/providers/providers.component.ts");
/* harmony import */ var _components_stores_stores_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/stores/stores.component */ "./src/app/modules/main-table/components/stores/stores.component.ts");
/* harmony import */ var _components_stocks_stocks_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/stocks/stocks.component */ "./src/app/modules/main-table/components/stocks/stocks.component.ts");
...
var MainTableModule = /** @class */ (function () {
    ...
    MainTableModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [_pages_table_table_component__WEBPACK_IMPORTED_MODULE_7__["TableComponent"], _components_products_products_component__WEBPACK_IMPORTED_MODULE_8__["ProductsComponent"], _components_providers_providers_component__WEBPACK_IMPORTED_MODULE_9__["ProvidersComponent"], _components_stores_stores_component__WEBPACK_IMPORTED_MODULE_10__["StoresComponent"], _components_stocks_stocks_component__WEBPACK_IMPORTED_MODULE_11__["StocksComponent"],],
            imports: [
                _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
                _main_table_routing_module__WEBPACK_IMPORTED_MODULE_6__["MainTableRoutingModule"],
...
/***/ "./src/app/modules/main-table/pages/table/table.component.html":
/*!*********************************************************************!*\
  !*** ./src/app/modules/main-table/pages/table/table.component.html ***!
  \*********************************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"row justify-content-start\">\r\n    <div class=\"col-5\">\r\n        <div class=\"row justify-content-between\">\r\n            <label class=\"form-label col-5\">\r\n                Tipo de elemento\r\n            </label>\r\n            <select class=\"form-control col-6\" [(ngModel)]=\"elementType\" (ngModelChange)=\"validateElementSelection()\">\r\n                <option *ngFor=\"let element of elementTypes\" [value]=\"element\">{{element}}</option>\r\n            </select>\r\n        </div>\r\n    </div>\r\n    <div class=\"col-12 mt-5\">\r\n        <ng-template [ngIf]=\"elementType === 'Productos' && hasProviders\">\r\n            <app-products></app-products>\r\n        </ng-template>\r\n        <ng-template [ngIf]=\"elementType === 'Proveedores'\">\r\n            <app-providers></app-providers>\r\n        </ng-template>\r\n        <ng-template [ngIf]=\"elementType === 'Tiendas'\">\r\n            <app-stores></app-stores>\r\n        </ng-template>\r\n        <ng-template [ngIf]=\"elementType === 'Inventarios' && hasProducts && hasStores\">\r\n            <app-stocks></app-stocks>\r\n        </ng-template>\r\n    </div>\r\n</div>"

/***/ }),

/***/ "./src/app/modules/main-table/pages/table/table.component.scss":
/*!*********************************************************************!*\
  !*** ./src/app/modules/main-table/pages/table/table.component.scss ***!
  \*********************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL21vZHVsZXMvbWFpbi10YWJsZS9wYWdlcy90YWJsZS90YWJsZS5jb21wb25lbnQuc2NzcyJ9 */"

/***/ }),

/***/ "./src/app/modules/main-table/pages/table/table.component.ts":
/*!*******************************************************************!*\
  !*** ./src/app/modules/main-table/pages/table/table.component.ts ***!
  \*******************************************************************/
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var src_app_core_utils_select_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/core/utils/select.utils */ "./src/app/core/utils/select.utils.ts");
/* harmony import */ var src_app_core_services_products_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/services/products.service */ "./src/app/core/services/products.service.ts");
/* harmony import */ var src_app_core_services_providers_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/core/services/providers.service */ "./src/app/core/services/providers.service.ts");
/* harmony import */ var src_app_core_services_stores_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/core/services/stores.service */ "./src/app/core/services/stores.service.ts");
...
var TableComponent = /** @class */ (function () {
    function TableComponent(_productsService, _providersService, _storesService, _msg) {
        this._productsService = _productsService;
        this._providersService = _providersService;
        this._storesService = _storesService;
        this._msg = _msg;
        this.elementTypes = src_app_core_utils_select_utils__WEBPACK_IMPORTED_MODULE_2__["ELEMENTTYPES"];
     ...
     */
    TableComponent.prototype.validateElementSelection = function () {
        var _this = this;
        switch (this.elementType) {
            case 'Productos':
                if (this.hasProviders) {
                    setTimeout(function () {
                        _this.previousElement = _this.elementType;
                    }, 5);
                }
                else {
                    this._msg.notify('warning', 'Disculpa, antes de manejar productos debes crear al menos un proveedor.', String(new Date().getTime()));
                    setTimeout(function () {
                        _this.elementType = _this.previousElement;
                    }, 5);
                }
                break;
            case 'Inventarios':
                if (this.hasStores && this._productsService) {
                    ...
                    setTimeout(function () {
                        _this.elementType = _this.previousElement;
                        _this._msg.notify('warning', 'Disculpa, antes de manejar inventarios debes crear al menos una tienda y un producto.', String(new Date().getTime()));
                    }, 5);
                }
                break;
            default:
    ...
    Object.defineProperty(TableComponent.prototype, "hasProviders", {
        /**
         * @name hasProviders
    ...
    Object.defineProperty(TableComponent.prototype, "hasProducts", {
        /**
         * @name hasProducts
    ...
    Object.defineProperty(TableComponent.prototype, "hasStores", {
        /**
         * @name hasStores
    ...
    TableComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-table',
            template: __webpack_require__(/*! ./table.component.html */ "./src/app/modules/main-table/pages/table/table.component.html"),
            styles: [__webpack_require__(/*! ./table.component.scss */ "./src/app/modules/main-table/pages/table/table.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_core_services_products_service__WEBPACK_IMPORTED_MODULE_3__["ProductsService"],
            src_app_core_services_providers_service__WEBPACK_IMPORTED_MODULE_4__["ProvidersService"],
            src_app_core_services_stores_service__WEBPACK_IMPORTED_MODULE_5__["StoresService"],
...
//# sourceMappingURL=modules-main-table-main-table-module.js.map